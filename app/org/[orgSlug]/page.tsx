  ...
  return (
    <>
      <section className="hero">
        ...
        <div className="badges"><span className="badge green">/{orgSlug}</span><span className="badge blue">Data scoped by organization_id</span></div>
      </section>
      ...
      <section className="panel">
        ...
        <div className="panel-body table-wrap"><table><thead><tr><th>Name</th><th>Role</th><th>Scope</th></tr></thead><tbody>{demo.staff.map((person: any) => <tr key={person.userId}><td>{person.name}</td><td>{person.role}</td><td>{demo.organization.name}</td></tr>)}</tbody></table></div>
      </section>
    </>
  );
}
